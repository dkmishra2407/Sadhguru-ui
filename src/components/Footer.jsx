                ...
                <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
                    <div>
                        ...
                        <div className="flex mt-8 space-x-6 text-gray-600">
                            ...
                            <a className="hover:opacity-75" href='https://www.instagram.com/swarajengineering?igsh=MXdwa2Zibjd6ZTJ4dA==' target="_blank" rel="noreferrer">
                    ...
                    <div className="grid grid-cols-1 gap-8 lg:col-span-2 sm:grid-cols-2 lg:grid-cols-4">
                        <div>
                            ...
                            <nav className="flex flex-col mt-4 space-y-2 text-sm text-gray-500">
                                <Link to='/aboutus'><a className="hover:opacity-75" href> About Us</a></Link>
                                <a className="hover:opacity-75" href='/products'> Our Products </a>
                                {/* <a className="hover:opacity-75" href> History </a> */}
                                <a className="hover:opacity-75" href='/career'> Careers </a>
                            </nav>
                        </div>
                        <div>
                            <p className="font-medium">
