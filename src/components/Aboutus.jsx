...
//                                     View More</a>
//                                 <a href="/aboutus" aria-label="" className="group inline-flex items-center font-semibold text-g1">Watch how
//                                     it works
  ...
  return (
    <div className="flex flex-col md:flex-row bg-white p-8">
      ...
      <div className="md:w-1/2" data-aos="fade-up">
        <img
          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSnXjgOb3ZfsjKjNZKjK-8F2kKAKzl9H_9aR5sKR00xMXhQ0LAi4yG6y9APOg&s" // Update with your image path
          alt="Kajaria Plant"
